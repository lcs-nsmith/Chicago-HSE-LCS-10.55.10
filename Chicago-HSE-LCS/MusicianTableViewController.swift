...
class MusicianTableViewController: UITableViewController {
    ...
    var BandMembers: [Musician] = [
        ...
        Musician(name: "Ryosuke Togawa", instrument: "Trumpet", Bio: "Ryosuke plays the trumpet as part of the pit band in this production. He is passionate about cooking food as much as he is playing the trumpet", ImageID: "ryosuke"),
