...
class CastMemberTableViewController: UITableViewController {
    ...
    CastMember(name: "Catherine Kim", character: "Roxie Hart", imageId: "facultyPlaceholderImage", bio: """
    ...
    CastMember(name: "Kate Bemrose", character: "Velma Kelly", imageId: "facultyPlaceholderImage", bio: """
    ...
    CastMember(name: "Lily Bowman", character: "Mama Morton", imageId: "facultyPlaceholderImage", bio: """
    ...
    CastMember(name: "Emile Biosjoly", character: "Billy Flynn", imageId: "facultyPlaceholderImage", bio: """
    ...
    CastMember(name: "Liam Davidson", character: "Amos Hart", imageId: "facultyPlaceholderImage", bio: """
        I’d write it for him- but he’d kill me.
        """),
        
    CastMember(name: "Liam Cole", character: "Fred Casely", imageId: "facultyPlaceholderImage", bio: """
    ...
    CastMember(name: "Cam Eatmon", character: "Mary Sunshine", imageId: "facultyPlaceholderImage", bio: """
    ...
    CastMember(name: "Ava Mason", character: "Liz", imageId: "facultyPlaceholderImage", bio: """
    ...
    CastMember(name: "Sierra Gibb", character: "Annie", imageId: "facultyPlaceholderImage", bio: """
        ...
        """),
    CastMember(name: "Val Torres", character: "June", imageId: "facultyPlaceholderImage", bio: """
        ...
        """),
    CastMember(name: "Isabelle Kim", character: "Mona", imageId: "facultyPlaceholderImage", bio: """
    ...
    CastMember(name: "Valentina Boren", character: "Hunyak (Delores)", imageId: "facultyPlaceholderImage", bio: """
    ...
    CastMember(name: "Rori Ash", character: "Veronica", imageId: "facultyPlaceholderImage", bio: """
    ...
    CastMember(name: "Mikayla Stoodley", character: "Kitty", imageId: "facultyPlaceholderImage", bio: """
    ...
    CastMember(name: "Will Hicks", character: "arrator/Ensemble", imageId: "facultyPlaceholderImage", bio: """
    ...
    CastMember(name: "Julio Midence", character: "Judge/Harry/Ensemble", imageId: "facultyPlaceholderImage", bio: """
    ...
    CastMember(name: "Ben Freeman", character: "Sgt Fogarty/Ensemble", imageId: "facultyPlaceholderImage", bio: """
    ...
    CastMember(name: "Marlow Florotto-Bickert", character: "Harrison/ Ensemble", imageId: "facultyPlaceholderImage", bio: """
    ...
    CastMember(name: "Maya Katsof", character: "Cell Block Dancer", imageId: "facultyPlaceholderImage", bio: """
    ...
    CastMember(name: "Pia Garcia", character: "Cell Block Dancer", imageId: "facultyPlaceholderImage", bio: """
    ...
    CastMember(name: "Razan Hammoud", character: "Cell Block Dancer", imageId: "facultyPlaceholderImage", bio: """
    ...
    """),
    CastMember(name: "Ximena Meneses", character: "Cell Block Dancer", imageId: "facultyPlaceholderImage", bio: """
    ...
    CastMember(name: "Carine Martin", character: "Cell Block Dancer", imageId: "facultyPlaceholderImage", bio: """
    ...
    CastMember(name: "Olivia Cantelon", character: "Cell Block Dancer", imageId: "facultyPlaceholderImage", bio: """
    ...
    CastMember(name: "Jayden Julian", character: "Ensemble Member", imageId: "facultyPlaceholderImage", bio: """
    ...
    CastMember(name: "Alejandra Porcar", character: "Ensemble Member", imageId: "facultyPlaceholderImage", bio: """
        ...
        """),
    CastMember(name: "Sophie Gray", character: "Ensemble Member", imageId: "facultyPlaceholderImage", bio: """
    ...
    CastMember(name: "Cristian Cicardo", character: "Ensemble Member", imageId: "facultyPlaceholderImage", bio: """
    ...
    CastMember(name: "Vince Dahm", character: "Ensemble Member", imageId: "facultyPlaceholderImage", bio: """
    ...
    CastMember(name: "Kaam Schlagenhauf", character: "Ensemble Member", imageId: "facultyPlaceholderImage", bio: """
    ...
    CastMember(name: "Eric Xia", character: "Ensemble Member", imageId: "facultyPlaceholderImage", bio: """
    ...
    CastMember(name: "Soroosh Siyoofi", character: "Ensemble Member", imageId: "facultyPlaceholderImage", bio: """
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = castMembers[indexPath.row].name
