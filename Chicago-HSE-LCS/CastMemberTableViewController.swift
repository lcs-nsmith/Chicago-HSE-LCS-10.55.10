...
class CastMemberTableViewController: UITableViewController {
    ...
    CastMember(name: "Sierra Gibb", character: "Annie", imageId: "sierraGibb", bio: """
        ...
        """),
    CastMember(name: "Val Torres", character: "June", imageId: "valentinaTorres", bio: """
    ...
    CastMember(name: "Will Hicks", character: "arrator/Ensemble", imageId: "willHicks", bio: """
    ...
    CastMember(name: "Julio Midence", character: "Judge/Harry/Ensemble", imageId: "julioMidence", bio: """
    ...
    CastMember(name: "Vince Dahm", character: "Ensemble Member", imageId: "vincentDahm", bio: """
